...
from model5 import DuelingDQN, DuelingDQNTrainer
...
class DuelingDQNAgent:
    def __init__(self):
        ...
        self.trainer = DuelingDQNTrainer(self.model, self.target_model, lr=LR, gamma=GAMMA)
    ...
    while True:
        ...
        if done:
            ...
            if agent.n_games % 100 == 0:
                metrics.plot_metrics("Dueling DQN")
